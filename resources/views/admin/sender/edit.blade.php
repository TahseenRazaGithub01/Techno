              ...
              <div class="email-side-nav remain-height ov-h">
                <div class="h-100 layers">
                  <div class="p-20 bgc-grey-100 layer w-100">
                    <a href="{{ route('admin.sender.listing') }}" class="btn btn-danger btn-block">View Sender Listing</a>
                  </div>
              ...
              <div class="email-wrapper row remain-height pos-r scrollable bgc-white">
                <div class="email-content open no-inbox-view">
                  <div class="email-compose">
                    ...
                    <form method="post" action="{{ route('admin.sender.update') }}" enctype="multipart/form-data" class="email-compose-body">
                      @csrf
                      
                      <input type="hidden" name="id" value="{{ $record->id }}">
                      <h4 class="c-grey-900 mB-20">Update Sender </h4>
                      <div class="send-header">
					  
						<div class="form-row">
						  <div class="form-group col-md-6">
							<label for="inputEmail4">Sender Name</label>
							<input type="text" required="required" class='form-control' value="{{ $record->name }}" name="name" placeholder="Complete Sender Name">
						 </div>
						 <div class="form-group col-md-6">
							<label for="inputPassword4">Sender Mobile</label>
							<input type="text" required="required" class='form-control' id="number" value="{{ $record->number }}" name="number" minlength="6" maxlength="8" placeholder="90348797">
							&nbsp;<span id="errmsg"></span>
						 </div>						  
