...
<html lang="en">
	<head>
		...
		<title>Law &mdash; Theme by Dusky team</title>
		<meta name="description" content="Free Bootstrap 4 Theme by dusky team">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark pb_navbar pb_scrolled-light" id="pb-navbar">
      <div class="container">
        <a class="navbar-brand" href="{{ url('') }}">Law</a>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-end">
          <div class="col-md-6  order-md-1">
            ...
            <div class="sub-heading"><p class="mb-5">A free template by <a href="#">dusky team</a> for Law Firm</p>
